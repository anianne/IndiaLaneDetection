...
test_images = plt.imread('C:/anish/1science/2018-2019/original-india/car-finding-lane-lines-master/test_images/YellowWhite.jpg')
...
#get_ipython().magic(u"time process_video('solidWhiteRight.mp4', 'white.mp4')")


# In[21]:


#get_ipython().magic(u"time process_video('solidYellowLeft.mp4', 'yellow.mp4')")


# In[22]:


#get_ipython().magic(u"time process_video('challenge.mp4', 'extra.mp4')")
