...
image = cv2.imread('C:/anish/1science/2018-2019/original-india/car-finding-lane-lines-master/test_images/YellowWhite.jpg')
cv2.imshow('original',image)
cv2.imshow('result',detector.process(image))
